...

{
    "scenario1" : {
        ...
        "Action": [Specific cooking actions, behaviors, movements, sequence, interaction patterns that can be performed in 5 seconds.],
        ...
        "Technical(Negative Prompt)": No human body parts, No captions, No unrealistic scenes, and No unrealistic scene transitions.
    },
}
"""
