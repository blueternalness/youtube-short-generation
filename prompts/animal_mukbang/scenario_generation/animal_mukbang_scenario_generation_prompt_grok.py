...
ANIMAL_MUKBANG_SCENARIO_PROMPT_WITHOUT_IMAGE_IMAGINE = """
...

{
    "scenario1" : {
        ...
        "Action": [Specific eating actions, behaviors, movements, sequence, interaction patterns that can be performed in 5 seconds.],
